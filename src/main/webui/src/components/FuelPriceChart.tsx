...
export interface FuelPriceForecastDto {
    timestamp: string;
...
export interface FuelPriceChartProps {
    entityId: string;
    fuelType: string;
    height?: number;
        ...
        <div className="relative w-full" style={{ height: height }}>
            ...
            <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chartData} margin={{ top: 25, right: 40, left: 10, bottom: 30 }}>
                    ...
                    />
                    <Tooltip content={<CustomTooltip fuelTypeName={getFuelTypeName(fuelType)} visibleLines={visibleLines} />} />
